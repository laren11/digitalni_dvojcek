                        ...
                        div {
                            div {
                                div {
                                    div {
                                        div {
                                            withClass = "cds-flex-f1g67tkn" and "cds-flex-end-f9tvb5a" and "cds-column-ci8mx7v" and "cds-flex-start-f1urtf06"
                                            withAttribute = "style" to "flex-grow:1;flex-shrink:1"
                                            span {
                                                findAll { eachText.take(26).forEach() { if(i in indexArray) {valueArray += it;i++ }else { i++}} }
                                            }
                                        }
                                    }
                                }
